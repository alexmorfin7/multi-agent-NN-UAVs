...
## Data ##
	...
	self.file_csv=open('/home/alexmorfin/catkin_ws/src/python_ob_docto/scripts/Pruebas_multi_sys_xy/prueba_%s_uav2.txt'%(self.archivo),'a')
...
############ uPDATE LAW ####
	...
	#print(self.w1)
    	#pdb.set_trace()         
        Fx = np.dot(self.wx.transpose(),self.brfx)*.001
	Fy = np.dot(self.wy.transpose(),self.brfy)*.001
	#print(F1)
    	#pdb.set_trace()
	#print(F1)
	return Fx, Fy
