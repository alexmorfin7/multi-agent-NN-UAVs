...
## Data ##
	...
	self.file_csv=open('/home/alexmorfin/catkin_ws/src/python_ob_docto/scripts/Pruebas_multi_sys_xy/prueba_%s_uav1.txt'%(self.archivo),'a')
...
## Update setpoint message
	...
	self.at.orientation = self.at_des.pose.orientation
        self.at.thrust = float(u)/self.a3+0.51
	self.data(ux,uy)
